...
+ (void)configSomeKindOfButtonLikeRegister:(UIButton *)button{
    [button setBackgroundImage:[Utils imageFromColor:SLPThemeColor.C1] forState:UIControlStateNormal];
    [button setBackgroundImage:[Utils imageFromColor:SLPThemeColor.C2] forState:UIControlStateHighlighted];
    [button setBackgroundImage:[Utils imageFromColor:SLPThemeColor.C2] forState:UIControlStateSelected];
    [button setBackgroundImage:[Utils imageFromColor:SLPThemeColor.C1Disable] forState:UIControlStateDisabled];
    [button setBackgroundColor:SLPThemeColor.C1Disable];
    [button setTitleColor:SLPThemeColor.C9 forState:UIControlStateNormal];
    [button.titleLabel setFont:SLPThemeFont.T1];
...
+ (void)setLableNormalAttributes:(UILabel *)label text:(NSString *)textStr fontSize:(CGFloat)fontSize height:(CGFloat)height {
    ...
    NSDictionary *attributes = @{
                                 NSFontAttributeName:[Utils fontWithSize:fontSize],
